...
const { hidePlaybackQueueView, hidePlayingView, showToast } = useMainViewStore()
            ...
            <div class="detail">
                ...
                <div class="action">
                    ...
                    <div class="clear-btn text-btn" @click="clearAll">
                        <svg width="14" height="14" viewBox="0 0 256 256" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
                            <path
