    ...
    <div class="song-item">
        ...
        <div class="title">
            ...
            <div class="action">
                ...
                <svg @click="addItem" width="15" height="15" class="add-btn spacing" viewBox="0 0 682.65 682.74" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg @click="deleteItem" width="16" height="16" class="delete-btn spacing" viewBox="0 0 256 256" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
                    <path
        ...
        <div class="artist spacing1">
            <ArtistControl :visitable="artistVisitable" :platform="data.platform"
                :data="data.artist" :track-id="toString(data.id)">
            </ArtistControl>
        </div>
        <div class="album spacing1">
            <AlbumControl :visitable="albumVisitable"
                :platform="data.platform" :data="data.album">
            </AlbumControl>
        </div>
    </div>
</template>
