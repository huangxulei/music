...
<template>
    ...
    <transition>
        <Notification class="common-ntf" v-show="commonNotificationShow">
            <template #text>
                <svg v-show="commonNotificationType == 0" width="36" height="36" viewBox="0 0 938.64 938.69" xmlns="http://www.w3.org/2000/svg">
                ...
                <svg v-show="commonNotificationType == 1" class="warning" width="36" height="36" viewBox="0 0 832.69 833.08" xmlns="http://www.w3.org/2000/svg">
                    <g id="Layer_2" data-name="Layer 2">
                        <g id="Layer_1-2" data-name="Layer 1">
                            <path
                            ...
                            <path d="M452.88,599.79c-.06,22.38-15.21,37.83-37,37.71-21.28-.12-36.23-15.84-36.18-38,.05-22,15.29-37.76,36.5-37.8C437.74,561.63,452.94,577.45,452.88,599.79Z" />
                        </g>
                    </g>
                </svg>
