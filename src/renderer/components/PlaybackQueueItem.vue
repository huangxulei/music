        ...
        <div class="item-wrap">
            ...
            <div class="right">
                    ...
                    <div class="bottom">
                        <div class="artist">
                            <ArtistControl :visitable="true" :platform="data.platform"
                                :data="data.artist" :trackId="data.id">
                            </ArtistControl>
                        </div>
                ...
                <div class="action">
                    ...
                    <svg width="16" height="16" class="spacing" viewBox="0 0 80 80" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg @click="removeItem" width="16" height="16" class="spacing" viewBox="0 0 256 256" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
                        <path
