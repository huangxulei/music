...
<template>
    <div class="play-ctl">
        <div class="play-mode-btn" @click="switchPlayMode">
            ...
            <svg v-show="playMode == 2" width="21" height="21" viewBox="0 0 895.9 896.32" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="play-prev-btn spacing " @click="playPrevTrack">
            <svg width="18" height="18" viewBox="0 0 24 28.01" xmlns="http://www.w3.org/2000/svg">
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
        ...
        <div class="play-btn spacing" @click="togglePlay">
            <svg v-show="!playing" width="18" height="18" viewBox="0 0 139 139" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <path
            ...
            <svg v-show="playing" width="24" height="24" class="paused" viewBox="0 0 100 100" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <path d="M44.2,78.3H32.1c-1.1,0-2-0.9-2-2V23.7c0-1.1,0.9-2,2-2h12.1c1.1,0,2,0.9,2,2v52.5C46.2,77.4,45.3,78.3,44.2,78.3z" />
                <path d="M67.9,78.3H55.8c-1.1,0-2-0.9-2-2V23.7c0-1.1,0.9-2,2-2h12.1c1.1,0,2,0.9,2,2v52.5C69.9,77.4,69,78.3,67.9,78.3z" />
            </svg>
        </div>
        ...
        <div class="playlist-btn spacing" @click.stop="togglePlaybackQueue">
            <svg width="18" height="18" viewBox="0 0 682.28 597.06" xmlns="http://www.w3.org/2000/svg">
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Layer_1-2" data-name="Layer 1">
                        <path
